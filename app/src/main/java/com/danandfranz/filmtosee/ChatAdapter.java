...
public class ChatAdapter extends BaseAdapter {
    ...
    private TwoFragment context;

    public ChatAdapter(TwoFragment context, List<ChatMessage> chatMessages) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        LayoutInflater vi = (LayoutInflater) context.getActivity().getSystemService(Context.LAYOUT_INFLATER_SERVICE);
